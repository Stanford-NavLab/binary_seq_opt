...
#SBATCH --job-name="257bffix_eurasip"
#SBATCH --mail-user=yalan@stanford.edu
#SBATCH --mail-type=END
#SBATCH --output=257bffix_eurasip_e%j.txt
#SBATCH --error=FAILURE_257bffix_eurasip_e%j.txt
#SBATCH --nodes=1
...
# Run script
julia --heap-size-hint=4G eurasip.jl 0 "" 257 130 4 ACZSOS false 1000000 1000000 true 5 5 false 100
