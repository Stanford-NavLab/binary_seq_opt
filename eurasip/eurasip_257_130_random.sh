...
#SBATCH --job-name="257rand_eurasip"
#SBATCH --mail-user=yalan@stanford.edu
#SBATCH --mail-type=END
#SBATCH --output=257rand_eurasip_e%j.txt
#SBATCH --error=FAILURE_257rand_eurasip_e%j.txt
#SBATCH --nodes=1
...
# Run script
julia --heap-size-hint=8G eurasip.jl 0 "" 257 130 25 ACZSOS true 1000000 1000000 false 5 5 false 100
